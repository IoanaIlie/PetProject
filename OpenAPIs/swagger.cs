...
namespace PetSwagger
{
    ...
    public partial class PetSwaggerClient
    {
        private string _baseUrl = "https://petstore.swagger.io/v2";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public PetSwaggerClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> AddPetAsync(Pet body)
        {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> AddPetAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var jsonContent = Newtonsoft.Json.JsonConvert.SerializeObject(body, _settings.Value);
                    var content_ = new System.Net.Http.StringContent(jsonContent);
                    ...
                    try
                    {
                        ...
                        {
                            PetResponse petResponse = await HandleResponseWithContent<PetResponse>(response_);
                            petResponse.ResponseStatus = status_;
                            return petResponse;
                        }
                        else
        ...
        private async Task<TSuccess> HandleResponseWithContent<TSuccess>(HttpResponseMessage response)
        {
            var stringResp = await response.Content.ReadAsStringAsync();
            if (response.IsSuccessStatusCode)
                //    return JsonConvert.DeserializeObject<TSuccess>(stringResp);
                return JsonConvert.DeserializeObject<TSuccess>(stringResp,
        new JsonSerializerSettings
        {
            ContractResolver = new NeverRequiredContractResolver()
        });
            //DeserializeJsonString<TSuccess>(stringResp);
            else throw new Exception("Cannot deserialize :" + stringResp);
        }
        private T DeserializeJsonString<T>(string response)
        {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> UpdatePetAsync(Pet body)
        {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> UpdatePetAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Pet>> FindPetsByStatusAsync(System.Collections.Generic.IEnumerable<PetStatus> status)
        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Pet>> FindPetsByStatusAsync(System.Collections.Generic.IEnumerable<PetStatus> statuses, System.Threading.CancellationToken cancellationToken)
        {
            if (statuses == null)
            ...
            using (var item_ = statuses.GetEnumerator())
            {
                while (item_.MoveNext())
                {
                    // urlBuilder_ = urlBuilder_.Append(System.Uri.EscapeDataString("status") + "=").Append((item_ == null) ? "" : System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
                    // urlBuilder_.Length--;
                    urlBuilder_.Append(System.Uri.EscapeDataString("status") + "=");
                    urlBuilder_.Append(item_.Current.ToString().ToLower()).Append("&");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            List<Pet> petsResponse = await HandleResponseWithContent<List<Pet>>(response_);
                            return petsResponse;
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> GetPetByIdAsync(long petId)
        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> GetPetByIdAsync(long petId, System.Threading.CancellationToken cancellationToken)
        {
            if (petId == null)
                throw new System.ArgumentNullException("petId");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            objectResponse_.Object.ResponseStatus = 200;
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == 400)
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> UpdatePetWithFormAsync(long petId, string name, string status)
        {
        ...
        /// <param name="status">Updated status of the pet</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> UpdatePetWithFormAsync(long petId, string name, string status, System.Threading.CancellationToken cancellationToken)
        {
            if (petId == null)
                throw new System.ArgumentNullException("petId");
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> DeletePetAsync(string api_key, long petId)
        {
        ...
        /// <param name="petId">Pet id to delete</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> DeletePetAsync(string api_key, long petId, System.Threading.CancellationToken cancellationToken)
        {
            if (petId == null)
                throw new System.ArgumentNullException("petId");
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<UserResponse> CreateUserAsync(User body)
        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<UserResponse> CreateUserAsync(User body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        UserResponse userResponse = await HandleResponseWithContent<UserResponse>(response_);
                        userResponse.ResponseStatus = status_;
                        return userResponse;
